          ...
          <div className="space-y-8">
            ...
            <div className="bg-white/5 border border-primary/20 p-8 clip-corner">
              ...
              <ul className="space-y-3">
                ...
                <li className="flex items-start gap-3">
                  <div className="w-1.5 h-1.5 bg-primary rotate-45 mt-2 flex-shrink-0"></div>
                  <span className="font-body text-gray-400">Prazo de entrega: 2 a 12 dias úteis, conforme a região. Frete grátis para Petrolina e Juazeiro, ou em compras acima de R$ 299,90.</span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-1.5 h-1.5 bg-primary rotate-45 mt-2 flex-shrink-0"></div>
