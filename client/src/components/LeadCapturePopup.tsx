  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      <DialogContent className="bg-black/90 border border-primary/30 backdrop-blur-xl p-0 max-w-4xl overflow-hidden sm:rounded-none clip-corner">
        <DialogTitle className="sr-only">Inscreva-se na newsletter ZUNO</DialogTitle>
          ...
          <div className="relative h-64 md:h-auto hidden md:block">
            ...
            <div className="absolute bottom-8 left-8 z-10">
              <div className="font-display font-bold text-4xl text-white mb-2">
                NEWSLETTER <span className="text-primary">ZUNO</span>
              </div>
              <p className="font-body text-gray-300 text-sm max-w-[200px]">
                Fique por dentro de novidades, desafios e promoções exclusivas.
              </p>
            </div>
          </div>
            ...
            {!isSubmitted ? (
              <>
                ...
                <p className="font-body text-gray-400 mb-8 leading-relaxed">
                  Cadastre-se para receber novidades sobre novos modelos, desafios da comunidade e promoções exclusivas.
                </p>
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                  ...
                  >
                    INSCREVER-SE <ArrowRight className="ml-2 w-4 h-4 group-hover:translate-x-1 transition-transform" />
                  </Button>
                </form>
              ...
              <div className="flex flex-col items-center justify-center text-center py-8 animate-in fade-in zoom-in duration-500">
                ...
                <p className="font-body text-gray-400">
                  Fique atento ao seu email. Vamos te avisar sobre novidades e promoções.
                </p>
              </div>
            )}
          </div>
